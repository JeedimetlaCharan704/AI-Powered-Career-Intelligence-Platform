var ProfileService = (function () {
  ...
  function calculateStrength (profile) {
    ...
    if (profile.projects && profile.projects.length) {
      var totalComplexity = profile.projects.reduce(function (sum, p) { return sum + (p.complexityScore || 50) }, 0)
      var totalImpact = profile.projects.reduce(function (sum, p) { return sum + (p.impactScore || 50) }, 0)
